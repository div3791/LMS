import{j as t}from"./index-8eB8ukBA.js";import{N as h,S as i,C as l,a as p,Q as m,b as c}from"./ConnectedTopics-SPFj48ZS.js";import{M as d}from"./MentalModel-7u6gqoEs.js";import{T as x}from"./TrapsTable-A2Pjt6E8.js";import{C as f}from"./CompareBlock-DUTyij-B.js";import{I as u}from"./InfoBox-CP92M4gW.js";const e={green:"#34D399",orange:"#F59E0B",red:"#F87171",muted:"#9CA3AF",white:"#F8FAFC",border:"#1E3A5F"};function y(){const a=[{old:"os.path.join(a, b)",neo:"Path(a) / b",label:"Join paths"},{old:"os.path.dirname(p)",neo:"Path(p).parent",label:"Parent dir"},{old:"os.path.basename(p)",neo:"Path(p).name",label:"Filename"},{old:"os.path.splitext(p)",neo:"Path(p).stem + .suffix",label:"Split ext"},{old:"os.path.exists(p)",neo:"Path(p).exists()",label:"Exists?"},{old:"os.path.isfile(p)",neo:"Path(p).is_file()",label:"Is file?"},{old:"os.makedirs(p,e_ok=T)",neo:"Path(p).mkdir(parents=T,exist_ok=T)",label:"Make dirs"}];return t.jsxs("svg",{viewBox:"0 0 520 210",xmlns:"http://www.w3.org/2000/svg",className:"w-full",children:[t.jsxs("defs",{children:[t.jsx("style",{children:`
